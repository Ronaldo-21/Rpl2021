...
<html lang="en">
  <head>
    ...
    <title>SIKP | User Profile Dosen</title>
  </head>
  <body>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-gray">
            ...
            <a class="navbar-brand font-weight-bold text-white" href="/dosen/home">SIKP <span class="sr-only">(current)</span></a>
      ...
      <main>
        ...
        <div class="card-container">
            ...
            <div class="lower-container">
                <div>
                    <p class="font-weight-bold">{{ $dosen_kp->nama }}</p>
                    <h5>{{ $dosen_kp->nik }}</h5>
                </div>
                <div>
                    <p>{{ $dosen_kp->email }}</p>
