...
class KoorController extends Controller
{
    ...
    public function prakp()
    {
    	...
    	return view('koor.pengajuanprakp', ['prakp' => $prakp, 'koor_kp' => $koor_kp]);
    }
    ...
    {
    	$user_koor = DB::table('koor_kp')->where('id_koor', '=', session('id_koor'))->get();
    	return view('userkoor', ['koor_kp' => $user_koor]);
    }
